 ...
 * @param {boolean=} ngStrictDi if this attribute is present on the js element, the injector will be
 ...
 *
 <example ng-js-included="true">
   <file name="index.html">
   <div ng-js="ngAppStrictDemo" ng-strict-di>
 ...
 * would result in the whole js "stalling" until all templates are loaded asynchronously - even in the
...
<div ng-js="App" ng-controller="DemoController as demo">
    //demo.label//
</div>
</file>
<file name="protractor.js" type="protractor">
